    ...
    return (
        <div className='bg-grey'>
            ...
            <div className='flex flex-col gap-3 font-bold items-center'>
                <button className='btn2 btn-outline p-4 h-fit'>
                ...
                <button className='btn2 btn-outline p-4 h-fit'>
                <Link href="https://www.credly.com/badges/6165d917-9627-47e1-aa5b-872172e31c2a/linked_in_profile" target='blank'>Google Data Anaytics Professional | Coursera | 2024</Link>
                    </button>
                <button className='btn2 btn-outline p-4 h-fit'>
